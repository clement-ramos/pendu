...
add_word_button = BUTTON(WHITE, 150, 300, 300, 60, "Add Word")
scoreboard_button = BUTTON(WHITE, 150, 400, 300, 60, "Scoreboard")
exit_button = BUTTON(WHITE, 200 ,500, 200, 60, "Exit")
...
def main():
    while True:
        ...
        write_text("Hangman", 72, 300, 100)
        # Draw buttons 
            
        play_button.draw(screen)
        add_word_button.draw(screen)
